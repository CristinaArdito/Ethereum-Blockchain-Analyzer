...
public class SolidityStatistics {
    ...
    public void getAddresses(String url) throws Exception {
        ...
        while ((inputLine = in.readLine()) != null) {
            ...
            for (String part : splited) {
            	if (part.contains("href='/address/") == true) {
     ...
     * @throws Exception
     */
    public void getAssembly(String url) throws Exception {
    	 URL website = new URL(url);
         URLConnection connection = website.openConnection();
         connection.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11");
         connection.connect();
    ...
    public static void main(String[] args) throws Exception {
    	SolidityStatistics ss = new SolidityStatistics();
    	// Crea la lista degli indirizzi
    	/*  for(int i=1; i<=1181; i++) {
    		if(i==1) {
    			ss.getAddresses("http://etherscan.io/contractsVerified");
    		}
    		else {
    			ss.getAddresses("http://etherscan.io/contractsVerified/"+i);
    		}
    	}*/
    	// Ottiene gli opcode 
